...
# Decidim::Shakapacker.register_stylesheet_import("stylesheets/decidim/plans/plans")
# Decidim::Shakapacker.register_stylesheet_import("stylesheets/decidim/plans/plans_form")
Decidim::Shakapacker.register_stylesheet_import("stylesheets/decidim/plans/plans_form", group: :admin)
