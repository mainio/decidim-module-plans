    ...
    describe PlansController do
      ...
      describe "GET show" do
        ...
        it "shows a single plan" do
          get :show, params: params.merge(id: plan.id)
          expect(response).to have_http_status(:ok)
        ...
        context "when the plan is hidden" do
          ...
          it "shows a single plan" do
            expect { get :show, params: params.merge(id: plan.id) }.to raise_error(ActionController::RoutingError)
          end
        end
      end
      ...
      describe "DELETE destroy" do
        ...
        it "destroys the plan" do
          ...
          expect do
            delete :destroy, params: params.merge(id: plan_to_destroy.id)
            expect(response).to have_http_status(:found)
      ...
      describe "POST publish" do
        ...
        it "publishes the plan" do
          post :publish, params: params.merge(id: plan.id)
          expect(response).to have_http_status(:found)
