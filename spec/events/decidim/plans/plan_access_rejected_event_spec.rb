...
describe Decidim::Plans::PlanAccessRejectedEvent do
  include_context "when a simple event"

  let(:event_name) { "decidim.events.plans.plan_access_rejected" }
  ...
  context "when the notification is for coauthor users" do
    ...
    describe "email_subject" do
      it "is generated correctly" do
        expect(subject.email_subject).to eq("#{requester_name} has been rejected to contribute in #{resource_title}.")
      end
    end
    ...
    describe "email_intro" do
      it "is generated correctly" do
        expect(subject.email_intro)
          .to eq(%(#{requester_name} has been rejected editing proposal <a href="#{resource_url}">#{resource_title}</a>.))
      end
    end
    ...
    describe "notification_title" do
      it "is generated correctly" do
        expect(subject.notification_title)
          .to include(%(<a href="#{requester_path}">#{requester_name} #{requester_nickname}</a> has been <strong>rejected to contribute</strong> in <a href="#{resource_url}">#{resource_title}</a>.))
      end
    end
  end

  context "when the notification is for the requester" do
    let(:event_name) { "decidim.events.plans.plan_access_requester_rejected" }

    it_behaves_like "a simple event"

    describe "email_subject" do
      it "is generated correctly" do
        expect(subject.email_subject).to eq("You have been rejected from contributing to #{resource_title}.")
      end
    end
    ...
    describe "email_intro" do
      it "is generated correctly" do
        expect(subject.email_intro)
          .to eq(%(You have been rejected from contributing to <a href="#{resource_url}">#{resource_title}</a>.))
      end
    end
    ...
    describe "notification_title" do
      it "is generated correctly" do
        expect(subject.notification_title)
          .to eq(%(You have been <strong>rejected from contributing</strong> to <a href="#{resource_url}">#{resource_title}</a>.))
      end
    end
  end
end
