...
describe Decidim::Plans::PlanAccessRejectedEvent do
    ...
    describe "email_intro" do
      it "is generated correctly" do
        expect(subject.email_intro)
          .to eq(%(#{requester_name} has been rejected to access as a contributor of <a href="#{resource_url}">#{resource_title}</a>.))
      end
    end
    ...
    describe "notification_title" do
      it "is generated correctly" do
        expect(subject.notification_title)
          .to include(%(<a href="#{requester_path}">#{requester_name} #{requester_nickname}</a> has been <strong>rejected to access as a contributor</strong> of <a href="#{resource_url}">#{resource_title}</a>.))
      end
    end
  end
  ...
  context "when the notification is for the requester" do
    ...
    describe "email_intro" do
      it "is generated correctly" do
        expect(subject.email_intro)
          .to eq(%(You have been rejected to access as a contributor of <a href="#{resource_url}">#{resource_title}</a>.))
      end
    end
    ...
    describe "notification_title" do
      it "is generated correctly" do
        expect(subject.notification_title)
          .to eq(%(You have been <strong>rejected to access as a contributor</strong> of <a href="#{resource_url}">#{resource_title}</a>.))
      end
    end
  end
end
